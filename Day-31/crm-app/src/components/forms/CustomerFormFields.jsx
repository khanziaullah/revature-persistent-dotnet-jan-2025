    ...
    <div className="form-fields">
      <div className="form-field">
        ...
        <input id="name" name="name" type="text"
          ...
          value={formData.name} onChange={onChange} placeholder="e.g. Jane Doe" autoComplete="name" />
      ...
      <div className="form-field">
        ...
        <input id="email" name="email" type="email"
          ...
          value={formData.email} onChange={onChange} placeholder="e.g. jane@acme.com" autoComplete="email" />
      ...
      <div className="form-field">
        ...
        <input id="company" name="company" type="text"
          ...
          value={formData.company} onChange={onChange} placeholder="e.g. Acme Corp" autoComplete="organization" />
      ...
      <div className="form-field">
        ...
        <input id="phone" name="phone" type="tel" className="form-input"
          value={formData.phone} onChange={onChange} placeholder="e.g. 415-555-0100" autoComplete="tel" />
      </div>
    </div>
  )
}
